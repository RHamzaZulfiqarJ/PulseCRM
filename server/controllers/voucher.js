...
export const getVouchers = async (req, res, next) => {
    try {
        ...
        const findedVouchers = await Voucher.find().populate('allocatedTo', 'firstName lastName').populate('project').exec()
...
export const createVoucher = async (req, res, next) => {
    try {
        ...
        await newVoucher.populate('allocatedTo', 'firstName lastName')
